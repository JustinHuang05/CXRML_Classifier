...
def train_model(model, train_loader, val_loader, criterion, optimizer, scheduler, device, num_epochs=25, patience=5):
    ...
    for epoch in range(num_epochs):
        ...
        print(f'Validation Loss: {val_loss:.4f}, Accuracy: {val_accuracy:.4f}, Balanced Accuracy: {balanced_acc:.4f}')
        ...
        if val_loss < best_val_loss:
            ...
            print('Model saved to best_model2.pth')
        else:
...
def validate_model(model, val_loader, criterion, device):
    ...
    val_accuracy = correct / total
    balanced_acc = balanced_accuracy_score(all_labels, all_preds)
    return val_loss, val_accuracy, balanced_acc
...
if __name__ == "__main__":
    ...
    # Transforms for validation and testing data, including conversion to grayscale
    ...
    # Path to the dataset
    dataPath = '/Users/justinhuang/Documents/Developer/ML/CXRML/POC/CXRData'
    ...
    test_loss, test_accuracy, test_balanced_acc = validate_model(best_model, test_loader, criterion, device)
